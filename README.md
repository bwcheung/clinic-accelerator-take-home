...
## What I decided to do about the messy bits (merged cells, spacer columns, formulas, etc.) and what trade-offs I made
  ...
  3. I used pandas beacuse it seems to be more effiecient in data analysis and dealing with larger data. openpyxl would be better at keeping the formatting. So I decided to not keep the value formatting like $ or % signs.
